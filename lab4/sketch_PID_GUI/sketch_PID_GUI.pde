...
public void CirclePosition(float theValue, float radius, float xOffSet, float yOffset) {
    xr = radius * cos(theValue) + xOffSet;
    yr = radius * sin(theValue) + yOffset;
